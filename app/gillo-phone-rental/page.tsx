      ...
      <main className="mx-auto max-w-5xl px-5 py-12 sm:px-8 sm:py-16">
            ...
            <div className="flex flex-col justify-center gap-4 text-sm text-slate-700">
              <div>
                ...
                <p className="mt-2">
                  ...
                  <span className="mt-1 block text-xs text-slate-500">※ 현재 기본 기종은 아이폰 12입니다.</span>
                </p>
              </div>
              <div>
        ...
        <section className="mb-16">
          <div className="mb-4 text-center sm:mb-6">
            <h2 className="text-base font-semibold text-slate-900 sm:text-lg">대치폰 패키지 구성</h2>
            <p className="mt-2 text-xs text-slate-600 sm:text-sm">
              대치폰 1대와 1년 학습 관리 서비스가 함께 제공되는 패키지입니다. 이후에는 학습 관리만 구독 형태로 연장할 수 있습니다.
            </p>
          </div>
