        ...
        <section className="mb-16">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <div className="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-7">
              ...
              <h2 className="mt-1 text-base font-semibold text-slate-900 sm:text-lg">기본에 충실한 모드</h2>
              <p className="mt-2 text-xs font-medium text-slate-500">“인터넷이랑 메신저만 막아주세요”의 구성</p>
              <ul className="mt-3 space-y-2 text-sm text-slate-700">
                <li>· 학습에 필요한 앱, 웹사이트만 허용, 나머지는 설치·실행 차단</li>
            ...
            <div className="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-7">
              ...
              <h2 className="mt-1 text-base font-semibold text-slate-900 sm:text-lg">시간표 기반 자동 제어</h2>
            ...
            <div className="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-7">
              ...
              <h2 className="mt-1 text-base font-semibold text-slate-900 sm:text-lg">주간 학습 리포트</h2>
