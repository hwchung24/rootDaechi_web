            ...
            <div className="mx-auto mt-12 grid max-w-[860px] grid-cols-1 gap-5 lg:grid-cols-2">
              ...
              <article className="rounded-[20px] border border-[#E5E7EB] bg-[#FAFAFA] p-6 md:p-10">
                ...
                <button
                  type="button"
                  disabled
                  className="mt-6 block w-full cursor-default rounded-[8px] border border-[#D1D5DB] bg-transparent px-6 py-3 text-center text-[14px] font-semibold text-[#9CA3AF] md:inline-block md:w-auto"
                >
                  출시 알림 신청
                </button>
              </article>
