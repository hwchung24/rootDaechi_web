...
const CARDS: {
  ...
  },
  {
    ...
    imageAlt: "플래너와 노트로 학습 계획을 세우는 장면"
  },
  {
    id: "parent",
    badge: "부모님과 함께",
      ...
      <div className="relative mt-10 sm:mt-12">
        <div className="lifestyle-scroll flex snap-x snap-mandatory gap-4 overflow-x-auto scroll-smooth px-5 pb-3 pt-1 motion-reduce:snap-none sm:gap-5 sm:px-8">
          {CARDS.map((card, i) => (
            <article
              key={card.id}
              className="relative h-[min(52vh,420px)] w-[min(88vw,360px)] shrink-0 snap-center overflow-hidden rounded-2xl sm:h-[min(50vh,440px)] sm:w-[min(72vw,380px)] lg:w-[380px]"
